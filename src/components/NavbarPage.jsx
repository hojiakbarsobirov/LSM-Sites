...
const NavbarPage = () => {
    return (
        <div className='shadow-lg bg-white w-full h-20 rounded-xl flex justify-between items-center px-8'>
            <i className='font-bold text-xl'>CoddyCamp</i>
            ...
            <div className='flex items-center'>
                <div className='flex space-x-5 px-4 border-r-2'>
                    <img className='w-6' src="./message.png" alt="" />
                    <img className='w-6' src="./notification.png" alt="" />
                </div>

                <div className='flex items-center px-5 space-x-3'>
                    <h2 className='font-medium'>Thomas Shelbek</h2>
                    <img className='w-6' src="./user.png" alt="" />
                </div>
            </div>
        </div>
    )
